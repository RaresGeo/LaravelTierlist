...
window.html2canvas = new __webpack_require__(/*! html2canvas */ "./node_modules/html2canvas/dist/html2canvas.js");
window.axios.defaults.headers.common['X-Requested-With'] = 'XMLHttpRequest';

window.tokenize = function (code) {
  var results = [];
...
window.isNumber = function (token) {
  return token !== undefined && token.match(/^[0-9]+$/) !== null;
};

window.isName = function (token) {
  return token !== undefined && token.match(/^[A-Za-z]+$/) !== null;
};

window.parse = function (code) {
